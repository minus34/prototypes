...
# calculates the area tolerance (in m2) for input into the Visvalingam-Whyatt vector simplification
...
################################################################################
# IMPORTANT: the defs below have not been converted to IAG/LocEng ready code
################################################################################
